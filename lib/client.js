...
`;
		...
		function CommunityTools() {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Menu, {
					...
					onSelect: (id) => {
						setMenuOpen(false);
						if (id === "members" || id === "roles" || id === "create-channel" || id === "invite-user" || id === "invite" || id === "settings") setDialog(id);
						if (id === "leave") (async () => {
							if (await askConfirm({
								title: "退出社区",
		...
		function MembersDialog({ open, onClose }) {
			...
			(0, react.useEffect)(() => {
				...
				let cancelled = false;
				setLoading(true);
				const bansTask = canBan ? listBannedUsers() : Promise.resolve([]);
				Promise.all([listMembers(), bansTask]).then(([ms, bs]) => {
					if (cancelled) return;
					setMembers(ms.map((m) => ({
						user: m.user,
						roleIds: m.roleIds,
			...
			async function makeAdmin(row) {
				...
				if (await setMemberRoles(row.user.id, next)) setMembers((prev) => prev.map((m) => m.user.id === row.user.id ? {
					...m,
					roleIds: next
				} : m));
			}
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(TalkModal, {
				...
				children: [
						...
						children: members.map((m) => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												targetIsOwner ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													style: {
														color: palette.muted,
														fontSize: 14
													},
												...
												self ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													style: {
														color: palette.muted,
														fontSize: 14
													},
											...
											children: held.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												style: {
													...smallText,
													fontSize: 14
												},
												children: "仅 @everyone"
											}) : held.map((r) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												style: {
													fontSize: 14,
													lineHeight: "18px",
													color: roleColorOf(r),
									...
									canTransfer ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.HoverCard, {
										openDelayMs: 300,
									...
									rowCanManage ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										...
										children: [
											canQuickAdmin && !m.roleIds.some((id) => adminRoleIds.has(id)) ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.HoverCard, {
												openDelayMs: 300,
												content: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ActionTip, {
													title: "设为管理员",
											...
											rowCanRoles ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
												size: "sm",
												variant: "ghost",
												onClick: () => setAssigning(m),
												children: "角色"
											}) : null,
											rowCanKick ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.HoverCard, {
												openDelayMs: 300,
												content: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ActionTip, {
													title: "移除成员",
											...
											rowCanBan ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.HoverCard, {
												openDelayMs: 300,
												content: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ActionTip, {
													title: "封禁成员",
					...
					assigning ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MemberRolesDialog, {
						...
						onSaved: (roleIds) => {
							setMembers((prev) => prev.map((m) => m.user.id === assigning.user.id ? {
								...m,
								roleIds
							} : m));
							setAssigning(null);
		...
		*/
		...
		function OnlineMembersModal({ open, onClose, loading, members, online, total }) {
			const rank = {
				online: 0,
				away: 1,
				offline: 2
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TalkModal, {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: {
							...liveDot,
							background: online > 0 ? palette.success : palette.muted
						} }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							style: {
								fontSize: 14,
								color: palette.text
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [talk.view.live ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Button, {
									size: "sm",
									variant: "ghost",
									icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconUserOutline16, {}),
		...
		function ProjectCard() {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: tipHint,
						children: "把「社区」装进 DSH：在 DeepSeek Harness 里和同好聊天、提问求助、发通知， 社区内容与你的 Agent 工作区不再割裂。"
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
						...
						children: PROJECT_REPO
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: tipHint,
						children: "点击回到首页（未进入社区时的默认页）"
					})
				]
			});
		}
		...
		function LogoutConfirmCard({ onConfirm }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				"data-dsht-logout-tip": true,
				style: {
					display: "flex",
					flexDirection: "column",
					gap: 8
		...
		function ProfileModal({ open, onClose }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TalkModal, {
				...
				footer: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
					...
					openDelayMs: 150,
					content: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LogoutConfirmCard, { onConfirm: () => void logout() }),
					anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
						variant: "outline",
						style: {
							color: palette.danger,
