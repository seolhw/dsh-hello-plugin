window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var ServerClient = class {
			...
			*  threadId 传讨论组 id 时返回该讨论组消息；缺省为主频道直接消息 */
			...
			listShares(opts = {}) {
				...
				return this.call("GET", `/api/shares/discover${qs}`, void 0, true);
			}
			...
			listMyShares(opts = {}) {
				...
				return this.call("GET", `/api/shares/mine${qs}`, void 0, true);
			}
			...
			deleteShare(shareId) {
				return this.call("DELETE", `/api/shares/${shareId}`, void 0, true);
			}
			/**
		...
		async function updateUserName(username) {
			...
			try {
				...
				try {
					setState({
						me,
						settings: await hostConfigSet({ handle: me.handle })
					});
				} catch {
					setState({ me });
				}
		...
		*/
		...
		async function cloneToLocal(downloadUrl) {
			try {
		...
		async function listPublicShares() {
			...
			if (!server) return [];
			try {
				return (await server.listShares({ limit: 30 })).items;
			} catch (error) {
				notify(errorText(error));
				return [];
			}
		...
		async function listMyShares() {
			...
			if (!server) return [];
			try {
				return (await server.listMyShares({ limit: 50 })).items;
			} catch (error) {
				notify(errorText(error));
				return [];
			}
		...
		async function listLocalSessions() {
			try {
				return (await hostSessions()).sessions;
			} catch (error) {
				notify(errorText(error));
				return [];
			}
		...
		*/
		...
		function Avatar({ label, color, size = 28, src }) {
		...
		const brandMark$1 = {
			...
			alignItems: "center",
			justifyContent: "center",
			background: "linear-gradient(135deg, var(--dsw-static-deepseek-500), var(--dsw-static-deepseek-400))",
			color: "#fff",
			fontWeight: 700,
			fontSize: 20,
			userSelect: "none",
		...
		function ForgotPasswordCard({ initialEmail, onDone }) {
			...
			const passwordToggle = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: stage === "done" ? "密码已更新" : "通过邮箱验证码找回账号"
						})]
					})]
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("form", {
							...
							children: [
								...
								otpError ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									style: errorBanner,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: {
											display: "inline-flex",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									style: {
										...pillKey$1,
										...privacy === "public" ? pillKeyActive$1 : {}
									},
									...
									style: {
										...pillKey$1,
										...privacy === "private" ? pillKeyActive$1 : {}
									},
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											style: {
												...pillKey$1,
												...kind === "announcement" ? pillKeyActive$1 : {}
											},
...
`;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [community.memberCount, " 名成员"] })
					})
				]
			});
		}
		function CommunitiesRail({ onAdd, onInbox, onShares, onEditProfile }) {
			const talk = useTalkState();
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: railMark,
						title: "dsh-talk 社区",
						children: me?.handle.slice(0, 1).toUpperCase() ?? "T"
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							display: "flex",
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								"aria-label": "分享广场",
								title: "分享广场",
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconShareOutline16, {})
							})
						]
					}),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: talk.communities.map((c) => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								children: [active ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: railPill }) : null, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.HoverCard, {
									openDelayMs: 300,
									content: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CommunityMetaCard, { community: c }),
		...
		function ForumGlyph() {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
				...
				strokeLinejoin: "round",
				"aria-hidden": true,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M6 8.5h8M6 12h5" }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", { d: "M20 20l-3.4-2.7H9a4 4 0 0 1-4-4V9a4 4 0 0 1 4-4h7a4 4 0 0 1 4 4v5.6a2 2 0 0 1-2 2h-.6z" })]
			});
		}
		/** 频道类型图标：文字 # / 公告 ! / 话题（气泡+横线），便于成员快速区分频道定位 */
		function ChannelGlyph({ kind }) {
			if (kind === "announcement") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				title: "公告频道",
				style: {
					display: "inline-flex",
					alignItems: "center",
			...
			if (kind === "forum") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				title: "话题频道",
				style: {
					color: palette.accent,
					display: "inline-flex",
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ForumGlyph, {})
			});
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						community.channels.map((ch) => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									...
									padding: "0 4px 0 8px",
									borderRadius: 8,
									background: active ? palette.hover : void 0,
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChannelGlyph, { kind: ch.kind })
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: {
											flex: 1,
											minWidth: 0,
		...
		function ForumTopicBoard({ channelId, onNewTopic }) {
			...
			const all = (talk.view.community?.threads ?? []).filter((t) => t.channelId === channelId);
			const byRecent = (a, b) => b.lastActivityAt - a.lastActivityAt;
		...
		function ChatPane() {
			...
			const MAX_ATTACH = 4;
			const [pendingShare, setPendingShare] = (0, react.useState)(null);
			const [sharePickOpen, setSharePickOpen] = (0, react.useState)(false);
			...
			const [threadCreateOpen, setThreadCreateOpen] = (0, react.useState)(false);
			const [threadSeed, setThreadSeed] = (0, react.useState)(null);
			...
			function acceptMention(member) {
				...
				setDraft(`${text.slice(0, start)}@${member.handle} ${text.slice(caret)}`);
				setMentionActive(false);
				setMentionQuery("");
				mentionStartRef.current = -1;
			...
			async function submit() {
				...
				if (await sendMessage(text, pendingFiles, pendingShare?.id ?? null)) {
					setDraft("");
					setPendingFiles([]);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: isThread ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconBranchOutline16, {}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChannelGlyph, { kind: channel?.kind ?? "text" })
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									minWidth: 0,
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: {
										...
										background: channel?.kind === "announcement" ? "var(--dsw-alias-state-warn-primary)" : palette.inputBg,
										border: channel?.kind === "text" ? `1px solid ${palette.border}` : "none"
									},
									children: channel?.kind === "announcement" ? "!" : "#"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: {
										fontSize: 13,
						...
						children: canPost ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									pendingShare ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										style: {
											display: "flex",
											alignItems: "center",
											gap: 8,
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												...
												children: ["附带分享卡片：", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													style: {
														fontWeight: 600,
														color: palette.text
													},
													children: pendingShare.title
												})]
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
												size: "sm",
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
								...
								disabled: talk.view.sending || draft.trim().length === 0 && pendingFiles.length === 0 && pendingShare === null,
								onClick: () => void submit(),
								"aria-label": "发送"
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SharePickerModal, {
					open: sharePickOpen,
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										...
										style: {
											...pillKey,
											...visibility === "public" ? pillKeyActive : {}
										},
										...
										style: {
											...pillKey,
											...visibility === "private" ? pillKeyActive : {}
										},
						...
						items.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [items.map((hit) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChannelGlyph, { kind: hit.channel.kind }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: {
												fontSize: 12,
												fontWeight: 600,
		...
		function UpdateUsernameModal({ open, onClose }) {
			const talk = useTalkState();
			const [value, setValue] = (0, react.useState)("");
			const [busy, setBusy] = (0, react.useState)(false);
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: "仅限字母、数字、下划线与点；4-30 位且全局唯一（@提及用）。若已被占用会自动提示。"
						})
					]
				})
			});
		}
		function ShareSnapshotModal({ open, onClose, channelId, channelName, communityId }) {
			const [tab, setTab] = (0, react.useState)("channel");
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				footer: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
					...
					children: busy ? "处理中…" : tab === "channel" ? "生成并复制链接" : "分享到本频道"
				})] }),
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: {
						display: "flex",
					...
					children: [
						...
						tab === "channel" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: {
								...smallText,
								fontSize: 12
							},
							children: "把本频道最近最多 200 条消息打包成 JSON 快照交服务端保管，并让本机 host 下载到本地 `~/.dsh-talk/clones`；生成后链接会复制到剪贴板。"
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
								flexDirection: "column",
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: ["把本机一个 DSH 会话打包上传，社区成员可「克隆到会话」还原出同样的 会话。当前：", getCurrentDshSession() ?? "（未识别到当前会话）"]
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: {
									display: "flex",
									flexDirection: "column",
								...
								children: sessions.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: "没有可分享的本机会话。"
								}) : sessions.map((s) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									type: "button",
		...
		function ShareGalleryModal({ open, onClose }) {
			const talk = useTalkState();
			...
			async function cloneSession(item) {
				if (busyId !== null) return;
				setBusyId(item.id);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: tab === "mine" ? "你还没有创建分享。" : "广场上还没有公开快照。"
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							display: "flex",
							flexDirection: "column",
						...
						children: items.map((item) => {
							...
							const messageCount = typeof item.manifest.messageCount === "number" ? item.manifest.messageCount : null;
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: discoverRow,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									style: {
									...
									children: [
										...
										item.summary ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											style: discoverDesc,
									...
									children: [
										...
										item.kind === "agent-session" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
											size: "sm",
											variant: "primary",
											disabled: busyId !== null,
											onClick: () => void cloneSession(item),
											children: busyId === item.id ? "还原中…" : "克隆到会话"
										}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
											size: "sm",
											variant: "ghost",
											disabled: busyId !== null,
											onClick: () => void clone(item),
											children: busyId === item.id ? "克隆中…" : "克隆到本地"
										}),
										mine ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
											size: "sm",
											variant: "ghost",
											disabled: busyId !== null,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: card.kind === "agent-session" ? "DSH 会话" : "频道快照"
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						style: {
							minWidth: 0,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: busy ? "获取中…" : "下载"
					})
				]
			});
		}
		/** 选择一张自己创建的分享，随消息一起发出 */
		function SharePickerModal({ open, onClose, onPick }) {
			const [items, setItems] = (0, react.useState)([]);
			const [loading, setLoading] = (0, react.useState)(false);
			(0, react.useEffect)(() => {
				if (!open) return;
				setLoading(true);
				listMyShares().then((list) => {
					setItems(list);
					setLoading(false);
				});
			}, [open]);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				children: loading ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: "你还没有分享。可在频道工具栏「分享」里生成一张。"
				}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: {
						display: "flex",
						flexDirection: "column",
		...
		function HomeScreen() {
			...
			const [showShares, setShowShares] = (0, react.useState)(false);
			const [showUsername, setShowUsername] = (0, react.useState)(false);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					inCommunity ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChannelList, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChatPane, {})] }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							...chatCol,
							alignItems: "center",
							justifyContent: "center"
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ShareGalleryModal, {
						open: showShares,
						onClose: () => setShowShares(false)
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(UpdateUsernameModal, {
						open: showUsername,
