					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: dialogHint,
									children: kind === "text" ? "全员自由发言。" : kind === "announcement" ? "仅所有者/管理员可发，普通成员只读。" : "提问消息可标记「已解决」，适合问答。"
								})
							]
						})
					]
...
`;
		...
		function MessageRow({ item }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: `dsht-msg-row${mentionedMe ? " is-mentioned" : ""}`,
				style: msgRow,
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Avatar, {
						...
						children: talk.view.messagesLoading ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									...
									children: channel?.kind === "announcement" && !canPost ? "暂无公告" : "还没有消息"
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: { fontSize: 12 },
									children: channel?.kind === "announcement" && !canPost ? "公告由所有者/管理员发布。" : "来说第一句吧。"
								})
							]
